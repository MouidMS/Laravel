    ...
    <div class="grid-holder">
        <div class="doc-container">
            <div class="grid-item-section">
                <?php $__currentLoopData = App\Http\Controllers\ProjectController::getCommuitny(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="grid-item">
                    <div class="holder-item">
                    <div id="main">
                        <div id="projectTop">
                            <a href="<?php echo e(url('page-community-id/'.$value->id)); ?>">
