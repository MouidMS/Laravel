...
<header>
    <div class="container">
        ...
        <a href="<?php echo e(url('/')); ?>"><img src="./project/images/Logopage.png" alt="logo" class="logo_img"></a>
        <nav>
            <ul class="main-nav" id="main-navMenu">
                <ul class="main-nav" id="main-navMenu">
                    <li><a href="<?php echo e(url('/writiner')); ?>">Home</a></li>
                    <li><a class="active" href="<?php echo e(url('/edit-text')); ?>">ReadyText Edit </a></li>
                    <li><a href="<?php echo e(url('/document')); ?>">Collector</a></li>
                    <li><a href="<?php echo e(url('/community')); ?>">Commnuity</a></li>
                </ul>
            </ul>
        </nav>
...
<?php /**PATH C:\Users\Mouyd\Desktop\Graduation Project II\project ll\gp-app\resources\views/landpage/EditText.blade.php ENDPATH**/ ?>