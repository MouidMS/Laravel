...
<div id="main-content">
    ...
    <?php if($linkBack == 'recent'): ?>
        <a href="<?php echo e(url('writiner')); ?>"> <button class="controlbtn" id="Back" ><i class="fa-solid fa-circle-arrow-left"></i></button></a>
    <?php elseif($linkBack == 'collector'): ?>
        <a href="<?php echo e(url('document')); ?>"> <button class="controlbtn" id="Back" ><i class="fa-solid fa-circle-arrow-left"></i></button></a>

    <?php elseif($linkBack == 'commuinty'): ?>
        <a href="<?php echo e(url('community')); ?>"> <button class="controlbtn" id="Back" ><i class="fa-solid fa-circle-arrow-left"></i></button></a>


    <?php elseif($linkBack == 'receive'): ?>
        <a href="<?php echo e(url('recent')); ?>"> <button class="controlbtn" id="Back" ><i class="fa-solid fa-circle-arrow-left"></i></button></a>
...
<script type="module">
    ...
    getInfo(<?php echo e($project); ?>,<?php echo e($commuinty); ?>,<?php echo e($receive); ?>,<?php echo e($collector); ?>)
    console.log(<?php echo e($project); ?>)
...
<?php /**PATH C:\Users\Mouyd\Desktop\Graduation Project II\project ll\gp-app\resources\views/landpage/page.blade.php ENDPATH**/ ?>