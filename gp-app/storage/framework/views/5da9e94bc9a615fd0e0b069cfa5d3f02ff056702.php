    ...
    <div class="P-popupRedXmark" id="popupRedXmark" style="display: block;">
        <div class="popupRedXmark">
            ...
            <div class="poptext">
                ...
                <p id="P-puptext"><?php echo e(session('update')); ?></p>
            </div>
        </div>
    </div>
    <script>
        ...
        displayMesage('<?php echo e(session('update')); ?>', true, 5);
    </script>
<?php endif; ?>
...
<?php /**PATH C:\Users\Mouyd\Desktop\Graduation Project II\gp-app\resources\views/landpage/Writiner_community.blade.php ENDPATH**/ ?>