...
//ready_text_edit
    ...
    /* new */
        ...
        Route::get('readytext', [ProjectController::class, 'getReadyText'])->middleware(['auth','verified']);
        Route::get('add-readytext/{json}', [ProjectController::class, 'addReadyText'])->middleware(['auth','verified']);
        Route::get('update-readytext/{json}', [ProjectController::class, 'updateReadyText'])->middleware(['auth','verified']);
