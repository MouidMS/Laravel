...
export default class ReadyTextDesign{
    ...
    constructor(bold,italic,underline,strikethrough,backColor,fontSize,fontName,foreColor,justifyCenter,justifyLeft,justifyRight,justifyFull,subscript,superscript,link){
        this.bold = bold;
        this.italic = italic;
