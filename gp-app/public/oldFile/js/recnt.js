...
class Project {
    ...
    setType(value) {
        ...
        switch (value) {
            case 'A4':
                this.getProjectType().src = "./m/projectVeiw/A4.png";
                break;
            case 'SL':
                this.getProjectType().src = "./m/projectVeiw/Slide.png";
                break;
            case 'WB':
                this.getProjectType().src = "./m/projectVeiw/blackboard.png";
                break
        }
    }
    ...
    setIsFavorit(value) {
        ...
        console.log(value)
        if (value) {
            this.getIsProjectFavorit().src = './m/projectVeiw/star-solid.svg';
        } else {
            this.getIsProjectFavorit().src = './m/projectVeiw/star-regular.svg';
        }
    }
